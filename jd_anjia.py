...
signUuid = 'd2512a119534406fbb12bc7fad4e2c4f'
...
def getCode():
    try:
        ...
        if response.status_code == 200 and len(code) > 30:
            ...
            return 'ARvQziHmfoAOI85tXjXZ5E7oeVP9kq2pYSH90mYt4m3fwcJlClpxrfmVYaGKuquQkdK3rLBQpEQH9V4tdrrh0w==','d2512a119534406fbb12bc7fad4e2c4f'
    except:
        return 'ARvQziHmfoAOI85tXjXZ5E7oeVP9kq2pYSH90mYt4m3fwcJlClpxrfmVYaGKuquQkdK3rLBQpEQH9V4tdrrh0w==','d2512a119534406fbb12bc7fad4e2c4f'
def mini(header):
