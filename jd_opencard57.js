...
All变量适用
————————————————
入口：[ 11.1~11.12 爆款福利，惠享低价 (https://lzdz4-isv.isvjcloud.com/dingzhi/syb/active/activity?activityId=dz2110100031064201&shareUuid=b698173a1b4a4e91b67e6199faf1f2b6)]
...
!(async () => {
  ...
  $.shareUuid = "b698173a1b4a4e91b67e6199faf1f2b6"
...
async function run() {
  try {
    ...
    if(false){
      ...
      if($.index === 1 || $.shareUuid == 'b698173a1b4a4e91b67e6199faf1f2b6') updateShareUuid($.shareUuid,0)
    }
